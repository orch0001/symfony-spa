 ...
 */
final class Version20250410150917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE interruption (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, service VARCHAR(255) NOT NULL, start DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
